describe("Get motor quote on Eldon", () => {
  describe("Should able to fill pre-quote details", () => {
    it("Enter your car details", () => {
      cy.visit("/vehicle");
      ...
      // TODO: refactor below to new it statement
      ...
      // if (cy.get('#ngb-typeahead-1-0').is(':visible')){
      //   click();
      // }
